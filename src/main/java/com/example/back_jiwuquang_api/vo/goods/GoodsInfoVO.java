...
public class GoodsInfoVO {
    ...
    public static GoodsInfoVO toGoodsInfo(Goods goods) {
        return new GoodsInfoVO()
                ...
                .setPostage(goods.getPostage())
                .setCategoryId(goods.getCategoryId())
                .setImages(goods.getImages())
                .setVideo(goods.getVideo())
                .setIsNew(goods.getIsNew())
                .setWarrantyTime(goods.getWarrantyTime())
                .setRefundTime(goods.getRefundTime())
                .setProvince(goods.getProvince())
                .setCity(goods.getCity())
                .setDistrict(goods.getDistrict());
    }
}
