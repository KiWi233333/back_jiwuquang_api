...
CREATE TABLE `comm_action`  (
  ...
  UNIQUE INDEX `unique_index`(`user_id`, `post_id`, `type`) USING BTREE
...
CREATE TABLE `comm_category`  (
  ...
  `sort_order` int(0) NULL DEFAULT 0 COMMENT '权重0,1,2,3增加权重',
  `is_show` tinyint(1) NULL DEFAULT 1 COMMENT '是否展示',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`) USING BTREE,
  INDEX `comm_category_parent_id`(`parent_id`) USING BTREE
...
CREATE TABLE `comm_post`  (
  ...
  `comment_top` char(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '评论置顶的评论ID',
  `views` int(0) NULL DEFAULT 0 COMMENT '浏览次数',
  `comments` int(0) NULL DEFAULT 0 COMMENT '评论次数',
  `likes` int(0) NULL DEFAULT 0 COMMENT '点赞次数',
  `status` tinyint(0) NOT NULL DEFAULT 0 COMMENT '状态：0-草稿，1-已发布，2-已删除',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `comm_post_user_id`(`user_id`) USING BTREE,
  INDEX `comm_category_id`(`category_id`) USING BTREE
...
CREATE TABLE `comm_post_comment`  (
  ...
  `views` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '浏览量',
  `likes` int(0) UNSIGNED NOT NULL DEFAULT 0 COMMENT '点赞数',
  `create_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `post_id`(`post_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `parent_id_i`(`parent_id`) USING BTREE
...
CREATE TABLE `goods_action`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `unique_index`(`user_id`, `goods_id`, `type`) USING BTREE
...
-- ----------------------------
INSERT INTO `goods_action` VALUES ('1666275306549604351', '1666275306549604354', '104215909657394688', 0, '2023-06-07 11:05:03');
INSERT INTO `goods_action` VALUES ('1666275306549604352', '1666278297176412162', '104215909657394689', 0, '2023-06-07 11:05:03');
INSERT INTO `goods_action` VALUES ('1666275306549604353', '2163652592439853323', '104215909657394690', 1, '2023-06-07 11:05:03');
INSERT INTO `goods_action` VALUES ('1666275306549604354', '1666275306549604354', '104215909657394691', 1, '2023-06-07 11:05:03');
INSERT INTO `goods_action` VALUES ('1666275306549604355', '1666278297176412162', '104215909657394692', 0, '2023-06-07 11:05:03');
INSERT INTO `goods_action` VALUES ('1666275306549604356', '2163652592439853323', '104215909657394693', 0, '2023-06-07 11:05:03');
...
CREATE TABLE `orders_comment`  (
  ...
  `is_recommend` int(0) NULL DEFAULT 0 COMMENT '是否推荐（0:不推荐,1:推荐）',
  `is_anonymous` int(0) NULL DEFAULT 0 COMMENT '是否匿名（0:不匿名,1:匿名）',
...
INSERT INTO `sys_user` VALUES ('2163652592439853323', 'Kiwi2333', '$2a$10$s68J2cbazN3oL9Ag8tFO5.GtzVF5Ns26fgTqrgLC1hD2oxKuCP30y', '1329634286@qq.com', '13415000000', 'Kiwi2333', '男', 'default.png', NULL, 0, '2022-03-01 10:00:00', '2023-05-29 11:03:52', '2023-05-29 11:03:52', '192.168.1.1', 1, 1, 1);
